...
export default function StoryMagazine(){
  ...
  return <section className="magazine" id="stories">
    <header className="magazine-masthead"><div><span>THE HUMAN STORY</span><h2>Stories from Nepal</h2><p>People, places and the moments behind every request for help.</p></div><div className="masthead-actions"><a href="/stories/manage">EDITORIAL DESK</a><button onClick={()=>setShowForm(true)}>＋ SHARE YOUR STORY</button></div></header>
